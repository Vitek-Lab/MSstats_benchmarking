...
TP<-m %>% filter(grepl(paste(proteins, collapse="|"),Protein) & `p-value` < .05) %>% nrow() #94
FP<-m %>% filter(!grepl(paste(proteins, collapse="|"),Protein)& `p-value` < .05) %>% nrow() #185
...
TP<-df %>% filter(grepl(paste(proteins, collapse="|"),ID) & p.adj < .05) %>% nrow() #198
FP<-df %>% filter(!grepl(paste(proteins, collapse="|"),ID) & p.adj < .05) %>% nrow() #94
#####################################################################################################
